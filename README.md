...
In this project we analyse the dances of honeybees
...
[`Circular GLMM Fitting.pdf`](2Results/Circular_GLMM_Fitting.pdf), [`Circular GLMM Summary.pdf`](2Results/Circular_GLMM_Summary.pdf) and [`colour_modelling.pdf`](2Results/colour_modelling.pdf).
