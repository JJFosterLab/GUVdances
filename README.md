...
Analysis summaries are provided as [`Analysis Summary.pdf`]("1Results/Analysis_Summary.PDF"), 
[`Circular GLMM Fitting.pdf`](1Results/Circular_GLMM_Fitting.pdf) and [`Circular GLMM Summary.pdf`](1Results/Circular_GLMM_Summary.pdf).
